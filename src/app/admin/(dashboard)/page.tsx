  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <Link
          href="/admin/jobs/new"
          className="px-5 py-2.5 bg-primary text-white rounded-xl font-bold text-sm hover:bg-primary-hover shadow-lg shadow-primary/20 transition-all"
        >
          + Post New Job
        </Link>
      </div>
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="text-sm text-gray-500 truncate">
                      {job?.title || 'Unknown position'} — {app.email}
                    </p>
                  </div>
